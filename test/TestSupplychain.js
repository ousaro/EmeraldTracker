...
contract('SupplyChain', async accounts => {
    ...
    const originMineName = 'Muzo mine'
    ...
    it("Testing smart contract function extractEmerald() that allows a Miner to extract emeralds", async() => {
        ...
        const decodeBasicData = Web3EthAbi.decodeParameters(['uint256','uint256','address','string','string','string','string'],resultBufferOne)
        
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc);
        const decodeDetailedData = Web3EthAbi.decodeParameters(['uint256','uint256','uint256','uint256','uint256','address','address','address','address'],resultBufferTwo)
        ...
        assert.equal(decodeBasicData[2], originMinerID, 'Error: Missing or Invalid originMinerID')
        assert.equal(decodeBasicData[3], originMineName, 'Error: Missing or Invalid originMineName')
        assert.equal(decodeBasicData[4], originMineInformation, 'Error: Missing or Invalid originMineInformation')
        assert.equal(decodeBasicData[5], originMineLatitude, 'Error: Missing or Invalid originMineLatitude')
        assert.equal(decodeBasicData[6], originMineLongitude, 'Error: Missing or Invalid originMineLongitude')
    ...
    // 15th Test
    it("Testing smart contract function packForSale() that allows a Manufacturer confirm the packing process", async() => {
        const supplyChain = await SupplyChain.deployed()
        ...
        // Mark an Emerald as Scaled by calling function scaleEmerald()
        let tx = await supplyChain.packForSale(           
            upc,
            {from: manufacturerID});
    ...
    // 16th Test
    it("Testing smart contract function publish() that allows a Manufacturer confirm the packing process", async() => {
        const supplyChain = await SupplyChain.deployed()
        ...
        // Mark an Emerald as Scaled by calling function scaleEmerald()
        let tx = await supplyChain.publish(           
            upc,
            {from: manufacturerID});
    ...
    // 18th Test
    it("Testing smart contract function shipToCustomer() that allows a Manufacturer ship an buyed emerald to a customermer", async() => {
        const supplyChain = await SupplyChain.deployed()
        ...
        // Mark an Emerald as Scaled by calling function scaleEmerald()
        let tx = await supplyChain.shipToCustomer(           
            upc,
            {from: manufacturerID});
    ...
    // 19th Test
    it("Testing smart contract function customerReceived() that allows a Manufacturer ship a buyed emerald to a customermer", async() => {
        const supplyChain = await SupplyChain.deployed()
        ...
        // Mark an Emerald as Scaled by calling function scaleEmerald()
        let tx = await supplyChain.customerReceived(           
            upc,
            {from: customerID});
